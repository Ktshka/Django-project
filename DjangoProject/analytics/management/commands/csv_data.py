...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        keywords = [
            'Специалист по информационной безопасности', 'безопасность', 'защита', 'information security specialist',
            'information security', 'фахiвець служби безпеки', 'cyber security'
        ]
